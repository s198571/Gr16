...
function start(){
	$("section").append("<div id='easter'>"+"<img src='falcon.gif' alt='Image of Falcon' width='350px'"+"</div>")//.gif hentet fra: "http://newbiedm.com/2010/08/23/the-importance-of-a-ship-in-your-star-wars-game/"
